...
class CfgPatches {
	class cTab {
		...
		versionAr[] = {2, 2, 2, 5};
		author = "cTab";
		authors[] = {"Gundy", "Riouken", "Raspu", "Ringrose"};
...
class cTab_Tablet_dlg {
	...
	class controls {
		...
		class EnemySub1 : cTab_RscControlsGroup {
			...
			class controls {
				...
				class uknbtn : cTab_MenuItem {
					idc = 200811;
					text = "$STR_ctab_core_MoreMenu";
					x = 0;
					y = "((27)) / 2048  * (safezoneH * 1.2) / 0.8 * (7 - 1)";
					w = "(12  + 1.5) * ((27)) / 2048  * (safezoneH * 1.2) * 3/4 * 0.5";
					h = "((27)) / 2048  * (safezoneH * 1.2) / 0.8";
					sizeEx = "((27)) / 2048  * (safezoneH * 1.2)";
					action = "[111] call cTab_fnc_userMenuSelect;";
				};
		...
		class EnemySub11 : cTab_RscControlsGroup {
			idc = 33011;
			x = "safeZoneXAbs + safeZoneWAbs";
			y = "safeZoneY + safeZoneH";
			w = "(12  + 1.5) * ((27)) / 2048  * (safezoneH * 1.2) * 3/4 * 0.5";
			...
			class controls {
				...
				class artfbtn : cTab_MenuItem {
					idc = 20031;
					text = "$STR_ctab_core_ArtFieldMenu";
					x = 0;
					y = "((27)) / 2048  * (safezoneH * 1.2) / 0.8 * (1 - 1)";
					w = "(12  + 1.5) * ((27)) / 2048  * (safezoneH * 1.2) * 3/4 * 0.5";
					h = "((27)) / 2048  * (safezoneH * 1.2) / 0.8";
					sizeEx = "((27)) / 2048  * (safezoneH * 1.2)";
					action = "cTabUserSelIcon set [1,14];[12] call cTab_fnc_userMenuSelect;";
				};
				
				class artsbtn : cTab_MenuItem {
					idc = 20041;
					text = "$STR_ctab_core_ArtSingleMenu";
					x = 0;
					y = "((27)) / 2048  * (safezoneH * 1.2) / 0.8 * (2 - 1)";
					w = "(12  + 1.5) * ((27)) / 2048  * (safezoneH * 1.2) * 3/4 * 0.5";
					h = "((27)) / 2048  * (safezoneH * 1.2) / 0.8";
					sizeEx = "((27)) / 2048  * (safezoneH * 1.2)";
					action = "cTabUserSelIcon set [1,15];[12] call cTab_fnc_userMenuSelect;";
				};
				
				class artmlrsbtn : cTab_MenuItem {
					idc = 20321;
					text = "$STR_ctab_core_ArtMLRSMenu";
					x = 0;
					y = "((27)) / 2048  * (safezoneH * 1.2) / 0.8 * (3 - 1)";
					w = "(12  + 1.5) * ((27)) / 2048  * (safezoneH * 1.2) * 3/4 * 0.5";
					h = "((27)) / 2048  * (safezoneH * 1.2) / 0.8";
					sizeEx = "((27)) / 2048  * (safezoneH * 1.2)";
					action = "cTabUserSelIcon set [1,16];[12] call cTab_fnc_userMenuSelect;";
				};
				
				class aagbtn : cTab_MenuItem {
					idc = 20051;
					text = "$STR_ctab_core_AAGunsMenu";
					x = 0;
					y = "((27)) / 2048  * (safezoneH * 1.2) / 0.8 * (4 - 1)";
					w = "(12  + 1.5) * ((27)) / 2048  * (safezoneH * 1.2) * 3/4 * 0.5";
					h = "((27)) / 2048  * (safezoneH * 1.2) / 0.8";
					sizeEx = "((27)) / 2048  * (safezoneH * 1.2)";
					action = "cTabUserSelIcon set [1,17];[12] call cTab_fnc_userMenuSelect;";
				};
				
				class aamibtn : cTab_MenuItem {
					idc = 20061;
					text = "$STR_ctab_core_AAMissileMenu";
					x = 0;
					y = "((27)) / 2048  * (safezoneH * 1.2) / 0.8 * (5 - 1)";
					w = "(12  + 1.5) * ((27)) / 2048  * (safezoneH * 1.2) * 3/4 * 0.5";
					h = "((27)) / 2048  * (safezoneH * 1.2) / 0.8";
					sizeEx = "((27)) / 2048  * (safezoneH * 1.2)";
					action = "cTabUserSelIcon set [1,18];[12] call cTab_fnc_userMenuSelect;";
				};
				
				class aamobtn : cTab_MenuItem {
					idc = 20071;
					text = "$STR_ctab_core_AAMotoMenu";
					x = 0;
					y = "((27)) / 2048  * (safezoneH * 1.2) / 0.8 * (6 - 1)";
					w = "(12  + 1.5) * ((27)) / 2048  * (safezoneH * 1.2) * 3/4 * 0.5";
					h = "((27)) / 2048  * (safezoneH * 1.2) / 0.8";
					sizeEx = "((27)) / 2048  * (safezoneH * 1.2)";
					action = "cTabUserSelIcon set [1,19];[12] call cTab_fnc_userMenuSelect;";
				};
		...
		class GenSub1 : cTab_RscControlsGroup {
			...
			class controls {
				...
				class minebtn : cTab_MenuItem {
					idc = 2028;
					text = "$STR_ctab_core_MinesMenu";
					toolTip = "$STR_ctab_core_MinesHint";
					x = 0;
					y = "((27)) / 2048  * (safezoneH * 1.2) / 0.8 * (3 - 1)";
					w = "(12  + 1.5) * ((27)) / 2048  * (safezoneH * 1.2) * 3/4 * 0.5";
					h = "((27)) / 2048  * (safezoneH * 1.2) / 0.8";
...
class cTab_android_on_screen_grid : cTab_android_on_screen_dirDegree {
	...
	w = "((((1167) - (20) * 6) / 5)*2) / 2048  * (safezoneW * 0.8)";
};
...
class cTab_android_on_screen_hookGrid : cTab_RscText_Android {
	...
	colorText[] = {1, 1, 1, 0.5};
	colorBackground[] = {0, 0, 0, 0.25};
	sizeEx = "(32) / 2048  * ((safezoneW * 0.8) * 4/3)";
};
...
class cTab_TAD_OSD_hookElevation : cTab_TAD_OSD_hookGrid {
	...
	w = "((((26) + 2) * 4) / 2048  * (safezoneH * 0.8 * 3/4))";
};
...
class cTab_TAD_OSD_hookDir : cTab_TAD_OSD_hookGrid {
	...
	w = "((((26) + 4) * 8) / 2048  * (safezoneH * 0.8 * 3/4))";
};
...
class cTab_microDAGR_on_screen_time : cTab_RscText_microDAGR {
	idc = 2613;
	style = 2;
	x = "((((24) + (573)) + (24) + ((((942) - (24) * 4) / 3)*0.75))) / 2048  * (safezoneH * 0.8 * 3/4) + (safezoneX + (safezoneW - safezoneH * 0.8 * 3/4) / 2)";
	y = "(((24) + (317))) / 2048  * (safezoneH * 0.8) + (safezoneY + 0.1 * safezoneH)";
	w = "((((942) - (24) * 4) / 3)*1.5) / 2048  * (safezoneH * 0.8 * 3/4)";
};
...
class CfgWeapons {
	...
	class CBA_MiscItem;	// External class reference
...
class RscTitles {
	...
	class cTab_microDAGR_on_screen_time : cTab_RscText_microDAGR {
		idc = 2613;
		style = 2;
		x = "((((24) + (573)) + (24) + ((((942) - (24) * 4) / 3)*0.75))) / 2048  * ((0.86) * 3/4) + (safeZoneX + (-0.05) * 3/4)";
		y = "(((24) + (317))) / 2048  * ((0.86)) + (safeZoneY + safeZoneH - (0.86) - (0.2))";
		w = ((((942) - (24) * 4) / 3)*1.5) / 2048  * ((0.86) * 3/4);
	};
