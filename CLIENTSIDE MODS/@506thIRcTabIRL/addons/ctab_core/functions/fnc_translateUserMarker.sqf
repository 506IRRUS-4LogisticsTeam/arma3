...
_texture1 = call {
	...
	if (_markerIcon == 14) exitWith {"\cTab\img\o_inf_artfield.paa"};
	if (_markerIcon == 15) exitWith {"\cTab\img\o_inf_artsingle.paa"};
	if (_markerIcon == 16) exitWith {"\cTab\img\o_inf_artmlrs.paa"};
	if (_markerIcon == 17) exitWith {"\cTab\img\o_inf_aaguns.paa"};
	if (_markerIcon == 18) exitWith {"\cTab\img\o_inf_aamissile.paa"};
	if (_markerIcon == 19) exitWith {"\cTab\img\o_inf_aamoto.paa"};
	...
	if (_markerIcon == 32) exitWith {"\cTab\img\b_mines.paa"};
	""
};
