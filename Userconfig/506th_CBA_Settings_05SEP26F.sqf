...
L_Immerse_exShakeIntensity = 0.6;
L_Immerse_force = true;
L_Immerse_forceIntensity = 0.45;
L_Immerse_recoil = true;
L_Immerse_recoilIntensity = 0.624077;
L_Immerse_twitch = true;
L_Immerse_twitchIntensity = 0.5;

// 506th Melee
force v506th_melee_friendlyfire = true;
...
force ace_advanced_fatigue_loadFactor = 1.18935;
force ace_advanced_fatigue_performanceFactor = 1;
force ace_advanced_fatigue_recoveryFactor = 5;
force ace_advanced_fatigue_terrainGradientFactor = 3.5004;
...
force ace_medical_blood_bloodLifetime = 30;
...
force ace_medical_ivFlowRate = 8;
force ace_medical_limbDamageThreshold = 5;
force ace_medical_limping = 1;
force ace_medical_painCoefficient = 1;
force ace_medical_painUnconsciousChance = 0.12;
...
force ace_medical_treatment_treatmentTimeIV = 17;
...
diwako_dui_indicators_icon_leader = false;
...
diwako_dui_linecompass_enableShowCustomWP = false;
diwako_dui_linecompass_IconOutline = 0;
diwako_dui_linecompass_occlusionFadeSpeed = 3.5;
diwako_dui_linecompass_showSpeaking = false;
...
diwako_dui_radar_always_show_player_number = false;
...
diwako_dui_radar_show_cardinal_points = false;
...
lambs_danger_disableAIFindStaticWeapons = true;
...
// ThermalImprovement
force ThermalImprovement_ALLOW_TANK_DRIVER = true;
force ThermalImprovement_ALLOW_VANILLA_TI = true;
force ThermalImprovement_ENABLE_ZEUS = true;
force ThermalImprovement_HD_VISION_FIGHTER = true;
force ThermalImprovement_HD_VISION_LANDVEH = true;
force ThermalImprovement_HD_VISION_SHIP = true;
force ThermalImprovement_HD_VISION_UAV = true;
force ThermalImprovement_REMOVE_FILMGRAIN_RHS = true;
...
zen_faction_filter_0_506th_fact_trainingwd = true;
...
zen_faction_filter_1_506th_fact_1506 = true;
zen_faction_filter_1_506th_fact_A1506 = true;
zen_faction_filter_1_506th_fact_B1506 = true;
zen_faction_filter_1_506th_fact_C1506 = true;
