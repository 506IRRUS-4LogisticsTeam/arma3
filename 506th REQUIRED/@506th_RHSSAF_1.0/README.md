...
This is the release note accompanying RHS: Serbian Armed Forces release. The mod requires `@AFRF` and `@USAF` mod to operate.
...
**NOTE: RHSSAF REQUIRED BOTH RHSAFRF AND RHSUSAF TO RUN**

## Usage

All the contents of the mod can be found in the Arsenal or Eden editor.
...
Red Hammer Studios: United States Armed Forces, Red Hammer Studios: Serbian Armed Forces, Red Hammer Studios: GREF or Red Hammer Studios: Escalation mods, you hereby 
...
distribution, using the Steam Workshop by anyone other than Red Hammer Studios.
...
Bohemia Interactive's approval of your monetization scheme does not grant you rights to wave this clause
of the EULA.
